...
import s from "./ProvidersSettings.module.css";
...
export function ProvidersSettings() {
  ...
  const name = providerAuth.provider
  ...
  return (
    <SettingsSection>
      <section className={s.provider} aria-label={name}>
        <header className={s.head}>
          <ProviderIcon provider={providerAuth.provider} size={28} />
          ...
          <>
            ...
            {url && (
              <form className={s.flow} onSubmit={complete}>
                <p>
                  After ChatGPT redirects to localhost, copy the callback URL
                  from the browser address bar and paste it here. The code alone
                  also works.
                </p>
                <label>
